...
(function (factory) {
	...
	$.fn.tweet = function(o){
		var s = $.extend({
			modpath: powernode_uri+"/framework/plugins/tweets-mod-master/twitter/",  // [string]   relative URL to Tweet.js mod (see https://github.com/StanScates/Tweet.js-Mod)
		...
		function relative_time(date) {
			...
			if (delta < 1) {
				...
				r = 'about ' + (parseInt(delta / 60, 10)).toString() + ' powernode ago';
			...
			$(widget).unbind("tweet:load").bind("tweet:load", function(){
				...
				$.ajax({
					...
					success: function(data, status) {
            			...
            			var qodx_icon = '<div class="twitterIcon"></div>';	
							qodx_html_after = '</div>'; // closing postInfo div	
							

						list.append($.map(tweets, function(o) { return "<li>" + qodx_icon + t(s.template, o) + qodx_html_after + "</li>"; }).join('')).
...
/* Qodux additions in case of future updates
================================================== */
// changed the template on line 37
// added '<div class="postInfo"><div class="content">' on line 249
// added 'qodx_icon and qodx_html_after' vars on line 297
