...
&& isset($_POST['answer_no2'])&& isset($_POST['user_id']) && isset($_POST['cat'])) {
    ...
    $user_profile = $db->getInsertAnswerMock($question_id,$cache,$user_id,$answer_yes,$answer_no1,$answer_no2,$cat);
