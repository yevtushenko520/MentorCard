...
alert('Error!');
    ...
    <strong><?php echo $posts1002[0]['soc1']?></strong>
    <p class="text-muted"><?php print_r(count($cat4));?> <?php echo $posts1002[0]['questions']?></p>
    </div>
...
<a>
    <div class="col-md-6" style="margin-top:5px;"  onclick="getCat(this)" id="3">
    <strong><?php echo $posts1002[0]['soc2']?></strong>
    <p class="text-muted"><?php print_r(count($cat3));?> <?php echo $posts1002[0]['questions']?></p>
    </div>
    <div class="col-md-6 text-right" style="margin-top:15px;"><i class="fa fa-info-circle fa-lg"></i></div>
...
<div class="col-md-6" style="margin-top:5px;"  onclick="getCat(this)" id="2">
<strong><?php echo $posts1002[0]['soc3']?></strong>
<p class="text-muted"><?php print_r(count($cat2));?> <?php echo $posts1002[0]['questions']?></p>
</div>
<div class="col-md-6 text-right" style="margin-top:15px;"><i class="fa fa-info-circle fa-lg"></i></div>
...
<a>
<div class="col-md-6" style="margin-top:5px;"  onclick="getCat(this)" id="1">
<strong><?php echo $posts1002[0]['soc4']?></strong>
<p class="text-muted"><?php print_r(count($cat1));?> <?php echo $posts1002[0]['questions']?></p>
</div>
<div class="col-md-6 text-right" style="margin-top:15px;"><i class="fa fa-info-circle fa-lg"></i></div>
