...
$posts4 = Yii::$app->db->createCommand('SELECT * FROM school  WHERE email="'.$model->school_name.'"')->queryAll();
...
foreach($posts09 as $role):
  ...
  $posts20 = Yii::$app->db->createCommand('SELECT COUNT(*) FROM cande_question WHERE cat="'.$posts02[0]['name'].'"')->queryAll();

 // SELECT COUNT(*) FROM cande_question WHERE cat="AM"

 // echo print_r($posts20[0]['COUNT(*)']);
    ...
    <div class="col-xs-6">
      <div class="info-box bg-yellow">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number"><?php echo $posts223[0]['COUNT(*)'] ?> <?php echo $posts1002[0]['of']?> <?php echo $all_cat_mock?> done</span>
...
<?php BoxWidget::begin([
        'title' => $posts1002[0]['school_info'], //string
        'border' => true,       //boolean
...
<?php BoxWidget::end();?>
 ...
 <?php BoxWidget::begin([
        'title' => $posts1003[0]['quest_stat'], //string
        'border' => true,       //boolean
