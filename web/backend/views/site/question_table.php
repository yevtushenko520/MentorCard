...
$posts1091 = Yii::$app->db->createCommand('SELECT * FROM filtr_quest_table  WHERE user_id='.$posts1228[0]['id'])->queryAll();

if($posts1091==null){

  $posts121 = Yii::$app->db->createCommand('INSERT INTO filtr_quest_table (user_id,cache) VALUES ('.$posts1228[0]['id'].'
                , 4)')->execute();
  ...
  <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              foreach($query245 as $kol):
                ...
                $query247 = Yii::$app->db->createCommand('SELECT * FROM qeust_tags WHERE tags_id='.$kol['tag_id'])->queryAll();

                foreach($query247 as $niga):

                  $ar_all[] = $niga['qeust_id'];
             ...
             /* $true = array();
              ...
              for($g=0;$g<=count($ar_all);$g++){

                $query246 = Yii::$app->db->createCommand('SELECT * FROM false_answer WHERE quest_='.$ar_all[$g].' AND user_id='.$posts228[0]['id'])->queryAll(); 
                ...
                $query247 = Yii::$app->db->createCommand('SELECT * FROM true_answer WHERE quest_='.$ar_all[$g].' AND user_id='.$posts228[0]['id'])->queryAll(); 
                ...
                if($query247!=null && $query246!=null){
...
*/
   ...
   <br>
      ...
      if($posts1091[0]['cache']==0){

        echo "
        <p>
<input type='checkbox' onchange='toggleCheckbox(this)' id='remember1' class='option-input checkbox subject-list' value='1' name='subject'/>
<span>True answers</span> </p>
<p>
<input type='checkbox' onchange='toggleCheckbox(this)' id='remember2' class='option-input checkbox subject-list' value='0' name='subject' checked/>
...
<span>Not answers</span> </p>
      ...
      }else if($posts1091[0]['cache']==1){

        echo "
        <p>
<input type='checkbox' onchange='toggleCheckbox(this)' id='remember1' class='option-input checkbox subject-list' value='1' name='subject' checked/>
<span>True answers</span> </p>
<p>
<input type='checkbox' onchange='toggleCheckbox(this)' id='remember2' class='option-input checkbox subject-list' value='0' name='subject' />
<span>False answers</span> </p>
<p>
<input type='checkbox' onchange='toggleCheckbox(this)' id='remember3' class='option-input checkbox subject-list' value='2' name='subject'/>
<span>Not answers</span> </p>
...
|| document.getElementById('remember3').checked ) {
...
alert('Error!');
    ...
    foreach($cart as $kok):
      ...
      $posts121 = Yii::$app->db->createCommand('INSERT INTO fast_test (new_pass) VALUES ("'.$kok.'")')->execute();
...
$posts109 = Yii::$app->db->createCommand('SELECT * FROM filtr_quest_table  WHERE user_id='.$posts1228[0]['id'])->queryAll();
//start
?>
...
//part0
   ...
   if($posts109[0]['cache']==0){

    

    if($posts11==null && $posts12!=null){
        ...
        echo " <strong>".$key['amtl_frage_nr']."</strong>";
     ...
     //$y_count
         ...
         echo $name2." - ".$posts1002[0]['points'].":".$key['points']."- B" ;
   ...
   }else if($posts109[0]['cache']==1){

    

    if($posts11!=null && $posts12==null || $posts11!=null && $posts12!=null){
