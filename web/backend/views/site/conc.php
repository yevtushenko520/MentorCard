...
<h3 class="box-title">Question - <?php echo $y.'/'.$c_all?> <br><?php echo $name_cat.': '.$posts2[0]['amtl_frage_nr'].'- 
        Error points: '.$posts2[0]['points']?></h3><div class="box-tools pull-right"></div></div>
...
$posts68 = Yii::$app->db->createCommand('SELECT question_id FROM cande_question WHERE cande="mock_test" AND cat="'.$posts02[0]['name'].'" ORDER BY RAND() LIMIT 10')->queryAll();
    ...
    $posts1375 = Yii::$app->db->createCommand('DELETE FROM  help WHERE user_id='.$posts11[0]['id'])->execute();
...
<div class="col-xs-6" >
    ...
    <p style="margin-left:5px;font-size:18px">Basic Material (<?php echo $giga2?>/<?php echo $count_basic?>)</p>
...
<div class="col-xs-6" >
    ...
    <p style="margin-left:5px;font-size:18px"><?php echo $posts22[0]['name']; ?> (<?php echo $giga3?>/<?php echo $posts145[0]['COUNT(*)']?>)</p>
...
if($count_y<=50){
 ...
 width='20' height='20' alt='lorem'>
            ";
                ...
                echo "<b>".$count_y."</b>."."
                <img onclick='onMy(this)'  style='margin-right: 20px;' id=".$cyka['quest_id']." src='images/gr_check.jpg' 
     width='20' height='20' alt='lorem'>
                ";
                    ...
                    echo "<b>".$count_y."</b>."."
                <img onclick='onMy(this)'  style='margin-right: 10px;' id=".$cyka['quest_id']." src='images/gr_check.jpg' 
     width='20' height='20' alt='lorem'>
                ";
            ...
            ";
             ...
             width='20' height='20' alt='lorem'>
                        ";
                            ...
                            echo "<b>".$count_y."</b>."."
                            <img onclick='onMy(this)' style='margin-right: 10px;' id=".$cyka['quest_id']." src='images/red_check.jpg' 
                 width='20' height='20' alt='lorem'>
                            ";
